...
/*
 * PPS periodic timer ID
 */
#define PPS_TIMER_ID                           (CY_PDUTILS_TIMER_USER_START_ID + 2u)
/*
 * PPS periodic timeout
 */
#define PPS_REQ_TIMER                          (2000u)

/* Voltage step increment */
#define PPS_STEP                               (100U)


/*
 * 5.0V Vbus voltage in 1mV units
 */
